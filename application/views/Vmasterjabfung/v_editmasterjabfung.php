<title>Edit Daftar Jabatan Fungsional</title>
        ...
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
              ...
              <div class="card-block col-6">
                <form method="post" action="<?php echo base_url('Cmasterjabfung/c_masterjabfung/updateMasterJabFung/' . $isi['id_jf']) ?>">
                  <div class="form-group">
                    <label for="nama_jf" class="col-form-label">Nama Jabatan Fungsional *</label>
                    <input type="text" class="form-control" name="nama_jf" value="<?php echo form_error('nama_jf')? set_value('nama_jf') : $isi['nama_jf'] ?>">
                  </div>
                  <div style="color: red;">
